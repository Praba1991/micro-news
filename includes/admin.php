...
<div class="wrap">
	...
	<form action="" method="post">
		Number of news to display : <input type="text" name="numPost" value="<?php echo get_option( "kush_mn_num_news");?>"/>
		<br/><br/>
...
$what='';	
	if(isset($_POST['k_mn_hidden']) && $_POST['k_mn_hidden']=='Y')
		...
		if($title!='')
			{				
			//$rows_affected = $wpdb->insert( $table_name, array( 'time' => current_time('mysql'), 'name' => $title, 'text' => $content, 'url' => $link ) );	
